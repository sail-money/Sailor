...
| `account.json` + a complete `.sail/strategy.md` + `.sail/strategies/strategies.json`, no tracked mandates | Strategy defined → **Station 3**: hand off to [`sailor-mandate-planner`](../sailor-mandate-planner/SKILL.md) |
