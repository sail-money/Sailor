...
const footerLinks = {
  Products:  ['Separately Managed Accounts', 'Yield Agent', 'Sonar Security'],
    ...
    <footer className={styles.footer}>
      <div className={styles.card}>
        <div className={styles.top}>
          ...
          {/* Left: big SAIL + tagline + socials + copyright */}
          <div className={styles.brand}>
            <div className={styles.wordmark}>SAIL</div>
            ...
            <p className={styles.copyright}>Agentic Finance Inc. © 2026</p>
          </div>
