...
/* Tint for the primary handoff button — a calm brand-blue that is
   elegant on its own, with no external brand color mixed in. */
    ...
    <div className={styles.overlay} role="dialog" aria-modal="true" onClick={onClose}>
      <GlassCard className={styles.card} onClick={(e) => e.stopPropagation()}>
        ...
        <p className={styles.foot}>
          Paste this into your AI coding agent to get started.
        </p>
      </GlassCard>
    </div>
  )
