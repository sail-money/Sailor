...
//     • Wrong slot offset → decoding the wrong parameter (type-checks, still wrong).
...
//
// SLOT OFFSETS
//   Slots are 0-based from the first constructor parameter (after the 4-byte
...
library SailCalldata {
    ...
    /// @notice Extract an address from ABI slot `i` (0-based after selector).
